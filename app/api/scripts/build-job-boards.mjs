...
// Monorepo: this file lives under app/api/scripts — repo root is three levels up.
const repoRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '../../..');
const tsPath = path.join(repoRoot, 'app/web/src/lib/jobWebsites.ts');
const outPath = path.join(repoRoot, 'app/api/data/job-boards.json');
